let menuColor = document.querySelector('.page-header');

window.onscroll = function () {
  if (window.pageYOffset > 300) {
    menuColor.classList.add('shown');
  } else {
    menuColor.classList.remove('shown')
  }
};
...
//       } else {
//         dots.append('<a href="#" class="slider__dot');
//       }
//
//     })
